                    ...
                    <div class="card-body">
                        <h4 class="form-section">
                            ...
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Enviar correo electrónico con motivo de creacion de  productos descontinuados</font>
                            </font>
                        ...
                        <hr>
                        <form id="form" name="formCorreo" method="post" action="/pointex/gestion/descontinuados/enviar_correo">
                            @csrf
                        ...
                        <a type="button" class="btn btn-raised btn-warning mr-1"
                           href="/pointex/gestion/descontinuados">
