...
{{--        <th class="column-title no-link last" style="text-align: center">Estatus</th>--}}
    ...
    <tbody>
    @foreach($descontinuadosAprobacion as $value)
        @php($kd = $value->first())
        <tr class="">
            <td class="last" align="center">
                <a href="/pointex/gestion/descontinuados?{{ base64_encode("edit=$kd->Id") }}">
                    <i class="ft-edit-2"></i>
                </a>
                &nbsp;&nbsp;&nbsp;
                <a href="/pointex/gestion/descontinuados?{{ base64_encode("editFecha=$kd->Id") }}">
...
{{--                                   title="Cambiar a Producto no descontinuado"--}}
{{--                                   id="{{ base64_encode("cambiarProducto=$v") }}"--}}
{{--                                   class="cambiar">--}}
{{--                                    <i class="fas fa-toggle-on success"></i>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                        </strong>--}}
{{--                    @endforeach--}}
