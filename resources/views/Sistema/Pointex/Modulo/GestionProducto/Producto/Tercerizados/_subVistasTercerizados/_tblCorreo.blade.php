            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <p>A continuación un listado de aprobaciones o rechazos de Productos Tercerizados.</p>
                    </div>
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1"
                                       href="#tab1" aria-expanded="true">Productos Tercerizados</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2"
                                       href="#tab2" aria-expanded="false">No Tercerizados</a>
                                </li>
                            </ul>
                                        ...
                                        @foreach($dataTercerizado as $kd)
                                            <tr class="">
                                                <td class="last" align="center">
                                                    <a href="/pointex/gestion/tercerizados?{{ base64_encode("aprobarUno=$kd->Id") }}"
                                                       class="success">
        ...
        function addNewOptionSelected(id, titulo, modelo, Observaciones) {
            swal({
                ...
                if (!valorObservaciones) {
                    ...
                    $.post("/pointex/gestion/tercerizados/save", dataFrm, function (resp) {
                        if (resp.STATUS == "OK") {
        ...
        function addNewOptionSelecteddos(id, titulo, modelo, Observaciones) {
            swal({
                ...
                if (!valorObservaciones) {
                    ...
                    $.post("/pointex/gestion/tercerizados/save_dos", dataFrm, function (resp) {
                        if (resp.STATUS == "OK") {
                            mensaje = "Datos guardados con exito";
                            successMsg();
                        } else {
