            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <p>A continuación un listado de aprobaciones o rechazos de Productos Market Access.</p>
                    </div>
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1"
                                       href="#tab1" aria-expanded="true">Productos Market Access</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2"
                                       href="#tab2" aria-expanded="false">No Market Access</a>
                                </li>
                            </ul>
                            <div class="tab-content px-1 pt-1">
                                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true"
                                    ...
                                    <table id="datatable-pais"
                                        ...
                                        <tbody>
                                        @foreach($dataTercerizado as $kd)
                                            <tr class="">
                                                <td class="last" align="center">
                                                    <a href="/pointex/gestion/market_access?{{ base64_encode("aprobarUno=$kd->Id") }}"
                                                       class="success">
                                                    ...
                                                    <code style="cursor: pointer;color: #9f191f"
                                                          ...
                                                          data-modelo="PX_GP_ProductoTercerizadoDetalle"
                                ...
                                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
                                    <div class="row" matchheight="card">
                                        ...
                                        <table id="datatable-pais"
                                            ...
                                            <tbody>
                                            @foreach($dataNoTercerizado as $kd)
                                                <tr class="">
                                                    <td class="last" align="center">
                                                        <a href="/pointex/gestion/market_access?{{ base64_encode("aprobarUno=$kd->Id") }}"
                                                           class="success">
        ...
        function addNewOptionSelected(id, titulo, modelo, Observaciones) {
            swal({
                ...
                if (!valorObservaciones) {
                    ...
                    $.post("/pointex/gestion/market_access/save", dataFrm, function (resp) {
                        if (resp.STATUS == "OK") {
        ...
        function addNewOptionSelecteddos(id, titulo, modelo, Observaciones) {
            swal({
                ...
                if (!valorObservaciones) {
                    ...
                    $.post("/pointex/gestion/market_access/save_dos", dataFrm, function (resp) {
                        if (resp.STATUS == "OK") {
                            mensaje = "Datos guardados con exito";
                            successMsg();
                        } else {
