<table
    ...
    <tbody>
{{--    @foreach($MarketAccessAprobacion as $value)--}}
    @foreach($MarketAccessAprobacionT as $value)
        @php($kd = $value->first())
        <tr class="">
            <td class="last" align="center"><br>
                ...
                <a href="/pointex/gestion/market_access?{{ base64_encode("editFecha=$kd->Id") }}">
                        ...
                        <strong>
                            <li>
                                <a href="javascript:void(0)"
                                   title="Cambiar a Producto no Market Access"
