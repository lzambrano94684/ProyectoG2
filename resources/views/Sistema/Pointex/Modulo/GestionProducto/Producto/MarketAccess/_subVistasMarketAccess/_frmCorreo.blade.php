                    ...
                    <div class="card-body">
                        <h4 class="form-section">
                            ...
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Enviar correo electrónico con motivo de creacion de  productos market access</font>
                            </font>
                        ...
                        <hr>
                        <form id="form" name="formCorreo" method="post" action="/pointex/gestion/market_access/enviar_correo">
                            @csrf
                            <input type="hidden" name="fecha" id="fecha" value="{{$fecha}}">
                                <input type="hidden" id="txtCorreoMarketAccess" class="form-control" name="txtCorreoMarketAccess" value="">
                        ...
                        <a type="button" class="btn btn-raised btn-warning mr-1"
                           href="/pointex/gestion/market_access">
