    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Estatus</h4>
                <p class="mb-0">Por favor llenar los campos para hacer una creación.</p>
            </div>
            <div class="card-content">
                <div class="px-3">
                    <form class="form form-horizontal" method="post" action="/pointex/gestion/regulatorio/Editarestatus" novalidate="novalidate" id="form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-actions">
                                <a type="button" class="btn btn-raised btn-warning mr-1" href="/pointex/gestion/regulatorio/edit_estatus">
