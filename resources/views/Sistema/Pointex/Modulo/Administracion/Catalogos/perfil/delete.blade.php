<!-- modal -->
<div class="modal fade text-left" id="DeletePerfil" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-content">
                <div class="modal-header bg-dark white">
                    ...
                    <div id="IdAddCapex">
                        <h4 class="modal-title text-bold-400" id="myModalLabel16">Eliminar</h4>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <h4 class="form-section"><i class="ft-user-x"> Eliminar uno o varios perfiles</i></h4>
                    ...
                    <form id="formCrearUser" name="formCrearUser" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2Modal" id="delete_slcUsuario" name="mod_slcUsuario">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2Modal" multiple="multiple" id="delete_slcPerfil"
                                    name="mod_slcPerfil[]">
                                <option value="">Seleccione</option>
                        ...
                        <div class="fg-actions d-flex justify-content-center">
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn-delete-perfil" onclick="eliminarUP()"
                                        class="btn btn-outline-danger">
                                    <i class="ft-save"></i> Eliminar
                                </button>
